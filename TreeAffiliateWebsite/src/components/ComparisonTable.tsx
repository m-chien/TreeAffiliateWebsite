...
const ComparisonTable = () => {
  ...
  return (
    <section
      className="comparison-section section-padding container"
      id="compare"
    >
      <motion.div
      ...
      >
        ...
        <p className="subtitle mx-auto">
          Tìm ra người bạn đồng hành xanh mát phù hợp với không gian và phong
          cách sống của bạn.
        </p>
      </motion.div>
      ...
      >
        <table className="compare-table">
          <thead>
            <tr>
              <th className="criteria-col" style={{ textAlign: "left" }}>
                Tiêu chí
              </th>
              {PLANTS_DATA.map((p) => (
                <th
                  key={p.id}
                  className={p.recommended ? "recommended-col" : ""}
                >
                  {p.recommended && (
                    <div className="rec-badge">Lựa Chọn Tốt Nhất</div>
                  )}
          ...
          <tbody>
            ...
            <tr>
              ...
              {PLANTS_DATA.map((p) => (
                <td
                  key={p.id}
                  className={`price-cell ${p.recommended ? "recommended-col font-bold text-orange" : ""}`}
                >
                  {p.price}
                </td>
              ))}
            ...
            <tr>
              ...
              {PLANTS_DATA.map((p) => (
                ...
                >
                  <a
                    href="#"
                    className={`btn ${p.recommended ? "btn-primary" : "btn-outline"} btn-sm`}
                  >
                    Xem giá tốt nhất
                  </a>
                </td>
