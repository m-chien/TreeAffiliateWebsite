...
/* Removed local TESTIMONIALS definition */
      ...
      <div className="container">
        ...
        >
          <h2 className="font-serif section-title">
            Đánh Giá & Review Cây Cảnh
          </h2>
          <p className="subtitle mx-auto">
            Khám phá hàng ngàn đánh giá từ cộng đồng người yêu cây cảnh của
            chúng tôi.
          </p>
        </motion.div>
        ...
        <div className="grid review-grid">
            ...
            <div className="prd-review-body">
              <div className="pros-cons grid">
                <div className="pros">
                  ...
                  <ul>
                    <li>
                      <CheckCircle2 color="#10B981" size={16} /> Dễ chăm sóc,
                      sinh trưởng nhanh
                    </li>
                    <li>
                      <CheckCircle2 color="#10B981" size={16} /> Khả năng lọc
                      không khí tuyệt vời
                    </li>
                    <li>
                      <CheckCircle2 color="#10B981" size={16} /> Kiểu dáng lá
                      độc đáo, hiện đại
                    </li>
                  </ul>
                </div>
                <div className="cons">
                  ...
                  <ul>
                    <li>
                      <AlertTriangle color="#EF4444" size={16} /> Cần không gian
                      tương đối rộng
                    </li>
                    <li>
                      <AlertTriangle color="#EF4444" size={16} /> Tránh ánh sáng
                      mặt trời gay gắt
                    </li>
                  </ul>
                </div>
              ...
              <div className="reviewer-verdict">
                <p>
                  "Monstera Deliciosa xứng đáng là nữ hoàng của cây trong nhà.
                  Sự phát triển mạnh mẽ cùng những chiếc lá xẻ thùy đặc trưng
                  mang lại vẻ đẹp nhiệt đới cho bất kỳ không gian nào. Tuy nhiên
                  hãy đảm bảo bạn có đủ không gian cho chúng vươn mình."
                </p>
              </div>
            </div>
          ...
          >
            <h3 className="font-serif mb-4 text-center">
