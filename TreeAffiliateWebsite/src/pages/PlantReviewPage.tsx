...
import { Star, CheckCircle, AlertTriangle, ExternalLink, ShieldCheck, Heart, Droplets, Sun, Wind, Leaf, Sprout } from "lucide-react";
  ...
  return (
    <div className={styles.reviewPage}>
      ...
      <div className={styles.container}>
        ...
        <section className={styles.hero}>
          ...
          <div className={styles.heroContent}>
            ...
            <span className={styles.scientificName}>{plantData.scientificName}</span>
            <div className={styles.ratingBox}>
              ...
              <span className={styles.reviewCount}>({plantData.reviews} nhận xét)</span>
            </div>
            <p className={styles.shortIntro}>
              Monstera Deliciosa, hay còn gọi là Trầu Bà Lá Xẻ, là "ông hoàng" của thế giới cây cảnh nội thất. 
              Với những chiếc lá xẻ độc đáo và kích thước ấn tượng, nó mang lại hơi thở nhiệt đới sang trọng cho bất kỳ không gian nào.
            </p>
          </div>
        </section>
        ...
        >
          <div className={styles.prosConsBox}>
            <div className={styles.prosCol}>
              <h3><CheckCircle className={styles.checkIcon} /> Ưu Điểm</h3>
            ...
            <div className={styles.consCol}>
              <h3><AlertTriangle className={styles.warnIcon} /> Nhược Điểm</h3>
              <ul className={styles.pList}>
              ...
              {plantData.vendors.map((v, i) => (
                <div key={i} className={styles.vendorItem}>
                  ...
                  <a href={v.link} className={styles.ctaBtn}>
                    Đến nơi bán <ExternalLink size={16} style={{marginLeft: '8px'}} />
                  </a>
                </div>
              ))}
            </div>
        ...
        >
          <article className={styles.reviewContent}>
            ...
            <h4><Sun size={20} style={{marginRight: '8px'}} /> Ánh sáng</h4>
            <p>
              Monstera ưa ánh sáng tán xạ, tránh ánh nắng trực tiếp gay gắt vì có thể làm cháy lá. 
              Vị trí lý tưởng là gần cửa sổ hướng Đông hoặc Tây nơi có rèm che mỏng. 
              Nếu thiếu sáng, cây sẽ chậm lớn và các lá mới sẽ ít xẻ hơn.
            </p>

            <h4><Droplets size={20} style={{marginRight: '8px'}} /> Chế độ nước</h4>
            <p>
              Tưới nước khi lớp đất mặt (khoảng 2-3cm) đã khô. Tránh để cây bị úng nước vì dễ gây thối rễ. 
              Vào mùa hè, bạn có thể phun sương lên lá để tăng độ ẩm, giúp lá bóng mượt hơn.
            </p>

            <h4><Wind size={20} style={{marginRight: '8px'}} /> Đất và Dinh dưỡng</h4>
            <p>
              Sử dụng hỗn hợp đất tơi xốp, thoát nước tốt (thường trộn thêm đá perlite hoặc vỏ thông). 
              Bón phân tan chậm hoặc phân hữu cơ định kỳ 1 lần/tháng trong mùa sinh trưởng để cây phát triển khỏe mạnh.
            </p>

            <h4><Heart size={20} style={{marginRight: '8px'}} /> Độ an toàn</h4>
            <p style={{color: '#C2714F', fontWeight: 'bold'}}>
              Lưu ý: Monstera chứa tinh thể canxi oxalat, có thể gây kích ứng miệng và tiêu hóa nếu nuốt phải. 
              Hãy đặt cây ở vị trí xa tầm tay trẻ nhỏ và thú cưng (chó, mèo).
            </p>
          </article>
        </motion.section>
      </div>
      ...
      <section className={styles.testimonialsSection}>
        <div className={styles.container}>
          <motion.h2 
            style={{textAlign: 'center', marginBottom: '3rem', fontFamily: 'Inter, serif'}}
            initial={{ opacity: 0 }}
          ...
          <div className={styles.testimonialsGrid}>
            ...
            >
              ...
              <p className={styles.tQuote}>
                "Cây mình mua về rất khỏe, lá xẻ rất đẹp. Đặt ở góc phòng khách làm không gian sang hẳn lên. Cảm ơn bài review rất chi tiết đã giúp mình tự tin hơn khi chăm cây!"
              </p>
            </motion.div>
            <motion.div 
              className={styles.testimonialCard}
            ...
            >
              ...
              <p className={styles.tQuote}>
                "Thông tin về ánh sáng và nước rất hữu ích. Mình từng làm chết một cây do tưới quá nhiều, giờ làm theo hướng dẫn thấy cây phát triển tốt lắm."
              </p>
            </motion.div>
          </div>
        </div>
