...
public class SecurityConfig implements WebMvcConfigurer {
        ...
        http.authorizeHttpRequests(request ->
                request.requestMatchers("/api/v1/anh/**").permitAll()
                        ...
                        .requestMatchers("/api/v1/admin/plants-manager/**").permitAll()
                        .requestMatchers("/api/v1/admin/files/**").permitAll()
                        .requestMatchers("/api/v1/khuyen-mai/**").permitAll()

                        // Trung
                        .requestMatchers("/api/v1/bai-viet/**").permitAll()
                        .requestMatchers("/api/v1/danh-muc-noi-dung/**").permitAll()
                        .requestMatchers("/api/v1/doi-tac/**").permitAll()
                        .requestMatchers("/api/v1/affiliate-order/**").permitAll()
